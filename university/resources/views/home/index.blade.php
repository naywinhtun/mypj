					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options='{"delay": 9000, "gridwidth": 1170, "gridheight": 500}'>
						<ul>
							<li data-transition="fade" class="typo-dark heavy">
								...
								data-y="285"
								data-start="2000"
								data-transform_in="y:[100%];opacity:0;s:500;"><a href="#" class="btn">Academic Calendar</a></div>
							</li>
						...
						data-transform_in="y:[100%];s:500;"
						data-transform_out="opacity:0;s:500;"
						data-mask_in="x:0px;y:0px;"><a href="#" class="btn">Academic Fees</a>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<div class="content-box text-center">
							...
							<div class="content-wrap">
								<h5 class="heading">Day Information</h5>
								<p>Lorem ipsum dolor sit amet his, consectetur adipiscing elit. Curabitur pellentesque</p>
							</div><!-- Content Wraper -->
						</div><!-- Content Box -->
					</div><!-- Column -->
					...
					<div class="col-sm-4">
						...
						<div class="content-box text-center">
							...
							<!-- Content Wraper -->
							<div class="content-wrap">
								<h5 class="heading">Distance Information</h5>
								<p>Lorem ipsum dolor sit amet his, consectetur adipiscing elit. Curabitur pellentesque</p>
							</div><!-- Content Wraper -->
						</div><!-- Content Box -->
					</div><!-- Column -->
					...
					<div class="col-sm-4">
						...
						<div class="content-box text-center">
							...
							<!-- Content Wraper -->
							<div class="content-wrap">
								<h5 class="heading">Students Center</h5>
								<p>Lorem ipsum dolor sit amet his, consectetur adipiscing elit. Curabitur pellentesque</p>
							</div><!-- Content Wraper -->
						</div><!-- Content Box -->
					</div><!-- Column -->
				...
				<div class="col-sm-12">
					<div class="title-container">
						<div class="title-wrap">
							<h3 class="title"><a href='history.php'>About University</a></h3>
			...
			<div class="row border-style">
				<div class="col-sm-4">
					...
					<div class="member-wrap">
						...
						<div class="member-img-wrap">
							<img width="600" height="500" src="images/teacher/teacher-v2-01.png" alt="Member" class="img-responsive">
						</div>
						<!-- Member detail Wrapper -->
						<div class="member-detail-wrap bg-white">
							<h5 class="member-name"><a href="rector.php">Prof. Jocop</a></h5>
							<span>Principal</span>
				...
				<div class="col-sm-4">
					...
					<div class="member-wrap">
						<!-- Member Image Wrap -->
						<div class="member-img-wrap">
							<img width="600" height="500" src="images/teacher/teacher-v2-02.png" alt="Member" class="img-responsive">
						</div>
						<!-- Member detail Wrapper -->
						<div class="member-detail-wrap bg-white">
							<h5 class="member-name"><a href="rector.php">Prof. Jonathan</a></h5>
				...
				<div class="col-sm-4">
					...
					<div class="member-wrap">
						<!-- Member Image Wrap -->
						<div class="member-img-wrap">
							<img width="600" height="500" src="images/teacher/teacher-v2-03.png" alt="Member" class="img-responsive">
						</div>
						<!-- Member detail Wrapper -->
						<div class="member-detail-wrap bg-white">
							<h5 class="member-name"><a href="rector.php">Prof. Soms</a></h5>
				...
				<div class="col-md-12">
					...
					<div class="isotope-filters">
						<ul class="nav nav-pills">
							...
							<li><a href="#" data-filter=".design" class="filter">Events</a></li>
							<li><a href="#" data-filter=".identity" class="filter">News</a></li>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="callto-action text-center">
					<h5 class="title"><span class="call-title-text"><span class="call-title-text">Need a copy of this beautiful Html5 so why are you waiting?</span></span><a href="#" class="btn">Buy now</a></h5>
				</div>
			</div><!-- Column -->
		</div><!-- row -->
	</div><!-- Container -->
